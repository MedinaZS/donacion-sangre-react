        ...
        <div className="accordion" id="accordionExample">
            <div className="accordion-item">
                <h2 className="accordion-header ">
                    <button className="accordion-button collapsed bg-secondary-subtle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAccordion" aria-expanded="false" aria-controls="collapseTwo">
                        {title}
                    </button>
                </h2>
                <div id="collapseAccordion" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body">
                        <div className="row row-cols-md-2">
                            {items && items.map((item, index) => (
                                <div key={index}>
                                    <h5>{item.local_donacion}</h5>
                                    Dirección: {item.direccion ? item.direccion : '-'} <br />
